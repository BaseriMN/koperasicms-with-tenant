...
return [
    ...
    'backup' => [
         ...
         * the backups.
         */
        'name' => env('APP_NAME', 'koperasicms-backup'),
        ...
        'source' => [
            'files' => [
                 ...
                 */
                'include' => [
                    // Kosong — kita backup DATABASE sahaja. Fail aplikasi datang dari git.
                ],
    ...
    'notifications' => [
        ...
        'mail' => [
            'to' => env('BACKUP_NOTIFY_EMAIL', 'muahamad.baseri@gmail.com'),
